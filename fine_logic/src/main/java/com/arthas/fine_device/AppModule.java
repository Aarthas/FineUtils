...
public class AppModule
{
    ...
    public static int $vercode() {
        int result = 0;
        String packageName = Logic.getApp().getPackageName();
        PackageInfo packageInfo;
        try {
            packageInfo = Logic.getApp().getPackageManager().getPackageInfo(packageName, 0);
    ...
    public static String $appname() {
        ...
        try {
            PackageManager packageManager = Logic.getApp().getPackageManager();
    ...
    public static boolean $running(String packageName) {
        if (packageName == null) {
            packageName = Logic.getApp().getPackageName();
        }
        ActivityManager am = (ActivityManager) Logic.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static boolean isTopActivy(String activityName) {
        ActivityManager manager = (ActivityManager) Logic.getApp().getSystemService(Context.ACTIVITY_SERVICE);
